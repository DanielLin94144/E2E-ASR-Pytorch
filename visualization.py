...
if __name__ == '__main__':
    ...
    ckpt_path = '/Home/daniel094144/E2E-ASR-Pytorch/ckpt/nofast_adadelta/best_aug.pth'
    ...
    os.makedirs('./demo/adadelta/', exist_ok=True)
    matplotlib.image.imsave('./demo/adadelta/feat34000-1.png', feat)
    matplotlib.image.imsave('./demo/adadelta/new_feat34000-1.png', new_feat)
